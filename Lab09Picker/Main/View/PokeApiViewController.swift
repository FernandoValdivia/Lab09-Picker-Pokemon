...
class PokeApiViewController: UIViewController {
    ...
    @IBOutlet var pokeListPicker: UIPickerView!
    @IBOutlet var pokeTextField: UITextField!
    ...
    override func viewDidLoad() {
        ...
        bind()
        setUpTextField()
        pokeImage.image = UIImage(named: "pokeball")
    }
    ...
    func setUpTextField() {
        ...
        pokeTextField.inputView = pokeTextField
    }
